...
К проекту по адресу http://158.160.3.182/redoc/ подключена документация API YaMDb.
...
### Адрес сервера с работающим приложением
  ...
  - http://158.160.3.182/api/v1/
  - http://158.160.3.182/admin
  - http://158.160.3.182/redoc